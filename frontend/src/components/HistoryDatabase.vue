<template>
  ...
  >
    ...
    <div class="section-header">
      ...
      <span class="section-title">{{ $t('home.predictionRecords') }}</span>
      <div class="section-line"></div>
    </div>
        ...
        <div class="card-header">
          ...
          <div class="card-status-icons">
            <span 
              ...
              :title="$t('history.graphBuildStep')"
            >◇</span>
            <span
              class="status-icon available"
              :title="$t('history.envSetupStep')"
            >◈</span>
            <span
              class="status-icon"
        ...
        <div v-if="selectedProject" class="modal-overlay" @click.self="closeModal">
          <div class="modal-content">
            ...
            <div class="modal-divider">
              ...
              <span class="divider-text">{{ $t('history.predictionReplay') }}</span>
              <span class="divider-line"></span>
            </div>
            ...
            <div class="modal-actions">
              ...
              >
                ...
                <span class="btn-text">{{ $t('history.graphBuildStep') }}</span>
              </button>
              <button 
              ...
              >
                ...
                <span class="btn-icon">◈</span>
                <span class="btn-text">{{ $t('history.envSetupStep') }}</span>
              </button>
              <button 
...
const getCardStyle = (index) => {
  ...
  if (isExpanded.value) {
    ...
    // Calculate card count in current row, ensure centering per row
  ...
  observer = new IntersectionObserver(
    (entries) => {
      entries.forEach((entry) => {
        ...
        // Use debounced delay for state switching to prevent rapid flickering
