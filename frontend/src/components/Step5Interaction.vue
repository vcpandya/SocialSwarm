        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">{{ $t('step5.reportAgentChatSubtitle') }}</div>
              </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? $t('step5.chatWithReportAgentHint') : $t('step5.chatWithAgentHint') }}
              </p>
            </div>
            <div 
...
const sendToReportAgent = async (message) => {
  addLog(t('step5.sentToReportAgent', { msg: message.substring(0, 50) + '...' }))
...
const sendToAgent = async (message) => {
  ...
  addLog(t('step5.sentToAgent', { name: selectedAgent.value.username, msg: message.substring(0, 50) + '...' }))
