...
const loadReportData = async () => {
  try {
    addLog(t('interactionView.loadReportData') + ': ' + currentReportId.value)
    ...
    if (reportRes.success && reportRes.data) {
        ...
        if (simRes.success && simRes.data) {
          ...
          if (simData.project_id) {
            ...
            if (projRes.success && projRes.data) {
              ...
              addLog(t('interactionView.projectLoaded') + ': ' + projRes.data.project_id)
      ...
      addLog(t('interactionView.reportInfoFailed') + ': ' + (reportRes.error || 'unknown'))
    }
  } catch (err) {
    addLog(t('interactionView.loadException') + ': ' + err.message)
  }
}
...
const loadGraph = async (graphId) => {
  ...
  try {
    ...
    if (res.success) {
      ...
      addLog(t('interactionView.graphLoaded'))
    }
  } catch (err) {
    addLog(t('interactionView.graphLoadFailed') + ': ' + err.message)
  } finally {
