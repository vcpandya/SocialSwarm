    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              {{ $t('home.descPart1') }}<span class=”highlight-bold”>MiroFish</span>{{ $t('home.descPart2') }}<span class=”highlight-orange”>{{ $t('home.agentScale') }}</span>{{ $t('home.descPart3') }}<span class=”highlight-code”>{{ $t('home.optima') }}</span>
            </p>
            <p class="slogan-text">
          ...
          <div class="console-box">
            ...
            <div class="console-section">
              <div class="console-header">
                <span class="console-label">01 / {{ $t('home.realitySeeds') }}</span>
...
// Computed property: whether form can be submitted
