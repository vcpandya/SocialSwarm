...
A. **Fallback types (must be included, placed as the last 2 in the list)**:
   - `Person`: Fallback type for any individual. When a person does not belong to any other more specific person type, classify them here.
...
- Ensure the source_targets of relationships cover your defined entity types
...
4. All entity types must be real-world agents that can post and interact, not abstract concepts
