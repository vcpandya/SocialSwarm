...
class ZepEntityReader:
    ...
    def _call_with_retry(
        ...
        Args:
            ...
            max_retries: Maximum retries (default 3, i.e., up to 3 attempts)
    ...
    def get_all_nodes(self, graph_id: str) -> List[Dict[str, Any]]:
        """
        Get all nodes from graph (with pagination)
        ...
        Returns:
            Node list
        """
        logger.info(f"Fetching graph {graph_id}  all nodes...")
    ...
    def get_all_edges(self, graph_id: str) -> List[Dict[str, Any]]:
        """
        Get all edges from graph (with pagination)
    ...
    def get_node_edges(self, node_uuid: str) -> List[Dict[str, Any]]:
        """
        Get all related edges for specified node (with retry mechanism)
    ...
    def filter_defined_entities(
        ...
        Filtering logic:
        - If node Labels only contain "Entity", this entity does not match predefined types, skip
        - If node Labels contain labels other than "Entity" and "Node", it matches predefined types, keep
        ...
        """
        logger.info(f"Starting graph entity filtering {graph_id}  entities...")
    ...
    def get_entity_with_context(
        ...
        """
        Get single entity with full context (edges and related nodes, with retry)
