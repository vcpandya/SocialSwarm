...
class AgentActivity:
    ...
    def to_episode_text(self) -> str:
        ...
        # Return "agent name: activity description" format directly, no simulation prefix
    ...
    def _describe_like_post(self) -> str:
        """Like post - includes original post and author info"""
    ...
    def _describe_dislike_post(self) -> str:
        """Dislike post - includes original post and author info"""
        post_content = self.action_args.get("post_content", "")
        post_author = self.action_args.get("post_author_name", "")
...
class ZepGraphMemoryUpdater:
    ...
    Monitors simulation actions log files, updates new agent activities to Zep graph in real-time.
    Groups by platform, sends batch to Zep after accumulating BATCH_SIZE activities.
    
    All meaningful actions are updated to Zep, action_args contains full context info:
    ...
    # Send interval (seconds), to avoid too-frequent requests
    SEND_INTERVAL = 0.5
    ...
    def __init__(self, graph_id: str, api_key: Optional[str] = None):
        ...
        # Per-platform activity buffers (each accumulates to BATCH_SIZE before batch send)
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        All meaningful actions are added to queue, including:
        - CREATE_POST
        - CREATE_COMMENT
        - QUOTE_POST
        - SEARCH_POSTS
        ...
        action_args contains full context info (e.g., original post text, username).
                ...
                try:
                    ...
                    with self._buffer_lock:
                        ...
                        if len(self._platform_buffers[platform]) >= self.BATCH_SIZE:
                            ...
                            # Send interval to avoid too-frequent requests
    ...
    def _send_batch_activities(self, activities: List[AgentActivity], platform: str):
        ...
        # Merge multiple activities into single text, newline-separated
